...
[ParticleType.LAVA]: {
  ...
  thermalCapacity: 0.95,     // Very high capacity - lava loses only 5% of emitted heat
  thermalConductivity: 0.4,  // Moderate conductivity - transfers heat but not too fast
},
